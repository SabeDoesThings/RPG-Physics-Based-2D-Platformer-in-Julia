...
function main()
    ...
    entities = [
        Entity(Vector2f(0.0, 0.0), grass_texture),
        Entity(Vector2f(30.0, 0.0), grass_texture),
        Entity(Vector2f(30.0, 30.0), grass_texture),
        Entity(Vector2f(30.0, 60.0), grass_texture)
    ]

    wilson = Entity(Vector2f(100.0, 50.0), grass_texture)
    push!(entities, wilson)
